...
import (
	...
	"github.com/gkwa/newtoniansheep/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.newtoniansheep.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".newtoniansheep")
	}
